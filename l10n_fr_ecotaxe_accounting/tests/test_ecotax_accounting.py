...
class TestEcotaxAccounting(TestAccountReconciliationCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.ecotaxe_journal = cls.env["account.journal"].create(
            {
                "name": "Ecotaxe",
                "code": "ECO",
                "type": "general",
        ...
        cls.ecotaxe_classification1 = cls.env["account.ecotaxe.classification"].create(
            {
                "name": "Fixed Ecotaxe 1",
                "ecotaxe_type": "fixed",
                "default_fixed_ecotaxe": 0.4,
                "ecotaxe_product_status": "M",
                "ecotaxe_supplier_status": "FAB",
                "ecotaxe_account_id": cls.ecotax_account1.id,
            }
        )
        cls.env.company.write(
            {
                "ecotaxe_account_id": cls.ecotax_account2.id,
                "ecotaxe_journal_id": cls.ecotaxe_journal.id,
            }
        )
        cls.ecotaxe_classification2 = cls.env["account.ecotaxe.classification"].create(
            {
                "name": "Fixed Ecotaxe 2",
                "ecotaxe_type": "fixed",
                "default_fixed_ecotaxe": 0.2,
                "ecotaxe_product_status": "M",
                "ecotaxe_supplier_status": "FAB",
            }
        )
    ...
    def test_invoice_ecotaxe_isolation(self):
        eco_class1_id = self.ecotaxe_classification1.id
        eco_class2_id = self.ecotaxe_classification2.id
                        ...
                        0,
                        {
                            ...
                            "ecotaxe_line_ids": [
                                (
                                    ...
                                    0,
                                    {
                                        "ecotaxe_classification_id": eco_class1_id,
                                    },
                                ),
                                (
                                    0,
                                    0,
                                    {
                                        "ecotaxe_classification_id": eco_class2_id,
                                    },
                                ),
                            ],
                        },
        ...
        ecotax_move = invoice.ecotaxe_move_id
        self.assertTrue(ecotax_move)
        self.assertEqual(ecotax_move.journal_id, self.ecotaxe_journal)
